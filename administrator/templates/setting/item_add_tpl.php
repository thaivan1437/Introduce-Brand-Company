		...
		<div id="content_lang_2<?=$key?>" class="tab_content">       	   
			...
			<div class="formRow">
			 ...
			 <div class="formRow">
				<label>Địa chỉ</label>
				<div class="formRight">
					<input type="text" value="<?=(@$item['diachi_'.$key])?>" name="diachi_<?=$key?>" title="Nhập địa chỉ công ty" class="tipS" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
    ...
    <div class="widget">
        ...
        <div class="formRow">
         ...
         <div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['twitter']?>" name="twitter" title="Nhập địa chỉ portfolio" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<input type="text" value="<?=@$item['fax']?>" name="fax" title="Nhập tên fax" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			<label>Hotline chạy</label>
			<div class="formRight">
				
				<input type="text" value="<?=@$item['hotline_l']?>" name="hotline_l" title="Nhập tên hotline" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
