	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<br>
				<?php }?>
				<input type="file" id="file" name="file" /><img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)"> Width(Rộng): 1350px & height(Cao): 619px;
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" id="ten_en" name="ten_en" value="<?=@$item['ten_en']?>"  title="Nhập tên" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Viết mô tả ngắn bài viết" class="tipS" name="mota_vi" id="mota_vi"><?=@$item['mota_vi']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Viết mô tả ngắn bài viết" class="tipS" name="mota_en" id="mota_en"><?=@$item['mota_en']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
