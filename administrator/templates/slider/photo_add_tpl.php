	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<br>
				<?php }?>
				<input type="file" id="file<?=$i?>" name="file<?=$i?>" /><img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)"> Width(Rộng): 1350px & height(Cao): 619px;
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Viết mô tả ngắn bài viết" class="tipS" name="mota<?=$i?>" id="mota<?=$i?>"><?=@$item['mota']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
