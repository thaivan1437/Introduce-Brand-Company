...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by : <a href="http://azaseo.com">Ndcorp</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a href="https://ibrandmedia.com.vn/" target="_blank"><span style="color:#f00;">Ibrand</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:info@ibrandmedia.com.vn">info@ibrandmedia.com.vn</a></strong></p>
