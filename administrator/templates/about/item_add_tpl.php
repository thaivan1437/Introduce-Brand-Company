	...
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" id="ngay" name="ngay" value="<?=@$item['ngay']?>"  title="Nhập thẻ ngày" class="tipS" />
				</div>
				<div class="clear"></div>
			</div>
		...
		<div id="content_lang_<?=$key?>" class="tab_content">        
			...
			<div class="formRow">
				<label>Vị trí</label>
				<div class="formRight">
					<input type="text" name="vitri_<?=$key?>" title="Nhập Vị trí" id="vitri_<?=$key?>" class="tipS" value="<?=@$item['vitri_'.$key]?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
