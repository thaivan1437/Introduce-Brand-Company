...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="default.php?com=hinhanh&act=man&type=<?=$_REQUEST["type"]?>"><span>album</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=hinhanh&act=save&type=<?=$_REQUEST["type"]?>&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
