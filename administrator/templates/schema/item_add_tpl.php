...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="default.php?com=schema&act=capnhat"><span>Thiết lập hệ thống</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=schema&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">	
