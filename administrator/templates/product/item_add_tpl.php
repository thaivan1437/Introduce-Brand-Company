	...
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="masp" title="Nhập mã dịch vụ" id="masp" class="tipS" value="<?=@$item['masp']?>" />
				</div>
				<div class="clear"></div>
			</div>
			 */?>
			<?php /* <div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="dvt" title="Nhập đơn vị tính" id="<?=@$item['dvt']?>" class="tipS" value="<?=@$item['dvt']?>" />
				</div>
				<div class="clear"></div>
			</div>
			*/ ?>
