...
<div class="box_content">
    <div class="tcat"><div class="icon"><h2><?= _thanhtoan ?></h2></div></div>
    <div class=" nds">
        <div class="row">
                ...
                <div class="box_dh">
                    ...
                    <?php if (is_array($_SESSION['cart'])) { ?>
                        <div class="table-responsive">
							...
							<th align="center" style="text-transform:uppercase;">Giá sale</th>
					...
					<div class="row">
								...
								<div class="pad-contact">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="row">
											...
											<div class="col-xs-6">
												Nhân viên giao nhận <?=$row_setting["ten_vi"]?> sẽ liên hệ với SĐT này.
											</div>
										</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="box-form">
								...
								<input id="same" class="checkbox_search" type="checkbox" name="checkbox"><label for="same"> <span></span> Thông tin nhận hàng và thông tin thanh toán của tôi giống nhau. </label><br />
								<div class="pad-contact">
									<div class="col-md-4 col-sm-4 col-xs-12 text-right" ><?= _hovaten ?>:</div>
									<div class="col-md-8 col-sm-8 col-xs-12"><input type="text" class="form-control" name="hotennhan" id="hotennhan" placeholder="<?= _hovaten ?>" value="" required oninvalid="this.setCustomValidity('<?= _hovaten ?>')" oninput="setCustomValidity('')">
									</div>
									<div class="clear"></div>
								</div>
								<div class="pad-contact">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="row">
											<div class="col-xs-6">
												<select name="province_nhan" id="province_nhan" class="input form-control">
													<option value='0'> --- Chọn tỉnh thành phố ---</option>
													<?php foreach($rs_province as $v){?>
											...
											<div class="col-xs-6">
												<select name="district_nhan" id="district_nhan" class="input form-control">
													<option value='0'> --- Chọn quận huyện ---</option>
										...
										<div class="clear height"></div>
										<input type="text" value="" class="form-control" name="diachinhan" id="diachinhan" placeholder="<?= _diachi ?>" required oninvalid="this.setCustomValidity('Nhập địa chỉ của bạn')" oninput="setCustomValidity('')">
									</div>
									<div class="clear"></div>
								</div>
								...
								<div class="pad-contact">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="row">
											<div class="col-xs-12">
												<input type="tel" pattern="[0][0-9]{9,10}" min="10" max="13" class="form-control" name="dienthoainhan" id="dienthoainhan" placeholder="<?=_sodienthoai?>" value="" required oninvalid="this.setCustomValidity('Nhập số điện thoại của bạn')" oninput="setCustomValidity('')">
											</div>
										</div>
								...
								<div class="pad-contact">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<button name="continue" class="continue" ><?= _tieptuc ?> >></button>
									</div>
								</div>
							</div>
						</div>
