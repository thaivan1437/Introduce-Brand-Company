...
if (isset($_GET['id'])) {
	...
	// breakcrumb
	$breakcrumb="<li><a href='http://".$config_url."'>"._trangchu." </a></li><li><a href='".$com."'>".$title_tcat." </a></li><li class='active'>".$tintuc_detail[0]["ten"];
    ...
    $sql_tintuc = "select ten_$lang as ten,tenkhongdau,mota_$lang as mota,thumb,id,ngaytao,luotxem,photo,type from #_$table where type='".$type."' and hienthi=1 order by stt,ngaytao desc";
    $d->query($sql_tintuc);

    $tintuc = $d->result_array();
	
	// breakcrumb
	$breakcrumb="<li><a href='http://".$config_url."'>"._trangchu." </a></li><li class='active'>".$title_tcat;
	//share
	$image_share='http://' . $config_url.'/' ._upload_hinhanh_l.$row_photo["logo"];
